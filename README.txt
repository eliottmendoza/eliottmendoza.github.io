...
———HTML5 UP (html5up.net | @ajlkn)
   ...for the HTML templates I started with and expanded on, licensed under the Creative Commons Attribution License.

———Responsive Tools (github.com/ajlkn/responsive-tools)
   ...for some JavaScript and CSS used with the templates I started with.

———jQuery (jquery.com)
   ...for some basic JavaScript functions.

———Poptrox (github.com/ajlkn/jquery.poptrox)
   ...for some JavaScript functions related to window popups.
